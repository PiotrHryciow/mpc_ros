# **MODEL PREDICTIVE CONTROL FOR REFERENCE PATH TRACKING IN ROS**
...
The model used is kinematic bicycle model.
...
of the models, but it also # **Autonomous driving with Model Predictive Control**
...
[gif1]: ./data/demo.gifmakes them more tractable.
